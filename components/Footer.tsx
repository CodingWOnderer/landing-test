    ...
    return (
        <footer className="dark bg-background">
            <div className="mx-auto max-w-7xl overflow-hidden px-6 pt-20 sm:pt-24 pb-10 lg:px-8">
                <nav
                    className="md:flex hidden justify-between -mb-6 columns-2 sm:flex sm:justify-center sm:space-x-12"
                    aria-label="Footer"
                >
                ...
                <p className="mt-10 text-center text-xs leading-5 text-white">
                    &copy; {currentYear} Capcons Analytics Private Limited; Capcons Inc.
                    All rights reserved.
                </p>
            </div>
        </footer>
