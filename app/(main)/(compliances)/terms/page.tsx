...
const Terms_Conditions = () => {
    return (
        <div className="md:container px-4 py-12">
            <div>
                <div className="max-w-3xl mx-auto prose prose-invert flex justify-center items-center py-5">
                    {" "}
                    <h1>Terms and Conditions</h1>
                </div>
            </div>
            <Article>
                <p>Updated as of 11.10.2022</p>
                ...
                <p>{`If you use our Service, you are considered a "User".`}</p>

                <h2>The Capcons Service</h2>
                <ul>
                    <li>
                ...
                <ul>
                    ...
                    <li>{`you can form a binding contract with Capcons;`}</li>
                    <li>
                ...
                <h2>Safety and Your Interactions with Other Members</h2>
                <ul>
                    <li>
                ...
                <ul>
                    ...
                    <li>{`use the Service in order to damage Capcons;`}</li>
                ...
                <section>
                    ...
                    <p>
                        ...
                        e-mail:`} <a href="support@capcons.com">support@capcons.com</a>
                    </p>
                    ...
                    <p>Capcons will terminate the accounts of repeat infringers.</p>
